    ...
    <div className="p-6 min-h-screen dark:bg-[#0d0b2b] transition-colors duration-300">
      ...
      {selectedAlbum && (
        <div className="fixed inset-0 bg-black bg-opacity-70 dark:bg-opacity-80 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
          <div className="relative w-[90vw] max-w-[1400px] h-[85vh] bg-[#fdfbf7] dark:bg-[#1a1740] rounded-lg shadow-2xl flex flex-col md:flex-row overflow-hidden border-2 border-gray-300 dark:border-purple-900/50 transition-colors duration-300">
            {/* 모드 전환 토글 */}
            <div className="absolute top-4 left-1/2 -translate-x-1/2 z-20 flex items-center bg-gray-200 dark:bg-gray-800 rounded-full p-1 gap-1 shadow-inner transition-colors">
              <button
            ...
            <button onClick={() => setSelectedAlbum(null)}
              className="absolute top-4 right-4 z-20 w-10 h-10 bg-gray-200 dark:bg-gray-800 hover:bg-red-500 dark:hover:bg-red-500 hover:text-white rounded-full flex items-center justify-center transition-colors text-gray-500 dark:text-gray-400">
